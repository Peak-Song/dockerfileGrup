...
) ENGINE=InnoDB  COMMENT='commit 历史表';
...
) ENGINE=InnoDB  COMMENT='使用配置的应用实例';
...
) ENGINE=InnoDB  COMMENT='应用实例的配置信息';
...
CREATE TABLE `NamespaceLock` (
                                 ...
                                 KEY `DataChange_LastTime` (`DataChange_LastTime`)
) ENGINE=InnoDB  COMMENT='namespace的编辑锁';
...
VALUES
    ('eureka.service.url', 'default', 'http://172.22.0.18:8080/eureka/', 'Eureka服务Url，多个service以英文逗号分隔'),
